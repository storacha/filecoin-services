...
func (_ServiceProviderRegistry *ServiceProviderRegistryCaller) GetAllProductCapabilities(opts *bind.CallOpts, providerId *big.Int, productType uint8) (struct {
	IsActive bool
	Keys     []string
	Values   [][]byte
}, error) {
	var out []interface{}
	err := _ServiceProviderRegistry.contract.Call(opts, &out, "getAllProductCapabilities", providerId, productType)
...
//
// Solidity: function getAllProductCapabilities(uint256 providerId, uint8 productType) view returns(bool isActive, string[] keys, bytes[] values)
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) GetAllProductCapabilities(providerId *big.Int, productType uint8) (struct {
	IsActive bool
	Keys     []string
	Values   [][]byte
}, error) {
	return _ServiceProviderRegistry.Contract.GetAllProductCapabilities(&_ServiceProviderRegistry.CallOpts, providerId, productType)
}

// GetAllProductCapabilities is a free data retrieval call binding the contract method 0xa6771f8b.
//
// Solidity: function getAllProductCapabilities(uint256 providerId, uint8 productType) view returns(bool isActive, string[] keys, bytes[] values)
func (_ServiceProviderRegistry *ServiceProviderRegistryCallerSession) GetAllProductCapabilities(providerId *big.Int, productType uint8) (struct {
	IsActive bool
	Keys     []string
	Values   [][]byte
}, error) {
...
func (_ServiceProviderRegistry *ServiceProviderRegistryCaller) GetProductCapabilities(opts *bind.CallOpts, providerId *big.Int, productType uint8, keys []string) ([][]byte, error) {
	var out []interface{}
...
//
// Solidity: function getProductCapabilities(uint256 providerId, uint8 productType, string[] keys) view returns(bytes[] values)
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) GetProductCapabilities(providerId *big.Int, productType uint8, keys []string) ([][]byte, error) {
...
//
// Solidity: function getProductCapabilities(uint256 providerId, uint8 productType, string[] keys) view returns(bytes[] values)
func (_ServiceProviderRegistry *ServiceProviderRegistryCallerSession) GetProductCapabilities(providerId *big.Int, productType uint8, keys []string) ([][]byte, error) {
	return _ServiceProviderRegistry.Contract.GetProductCapabilities(&_ServiceProviderRegistry.CallOpts, providerId, productType, keys)
}
...
func (_ServiceProviderRegistry *ServiceProviderRegistryCaller) GetProviderWithProduct(opts *bind.CallOpts, providerId *big.Int, productType uint8) (ServiceProviderRegistryStorageProviderWithProduct, error) {
	var out []interface{}
...
//
// Solidity: function getProviderWithProduct(uint256 providerId, uint8 productType) view returns((uint256,(address,address,string,string,bool),(uint8,string[],bool),bytes[]))
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) GetProviderWithProduct(providerId *big.Int, productType uint8) (ServiceProviderRegistryStorageProviderWithProduct, error) {
...
//
// Solidity: function getProviderWithProduct(uint256 providerId, uint8 productType) view returns((uint256,(address,address,string,string,bool),(uint8,string[],bool),bytes[]))
func (_ServiceProviderRegistry *ServiceProviderRegistryCallerSession) GetProviderWithProduct(providerId *big.Int, productType uint8) (ServiceProviderRegistryStorageProviderWithProduct, error) {
	return _ServiceProviderRegistry.Contract.GetProviderWithProduct(&_ServiceProviderRegistry.CallOpts, providerId, productType)
}
...
func (_ServiceProviderRegistry *ServiceProviderRegistryCaller) GetProvidersByProductType(opts *bind.CallOpts, productType uint8, onlyActive bool, offset *big.Int, limit *big.Int) (ServiceProviderRegistryStoragePaginatedProviders, error) {
	var out []interface{}
	err := _ServiceProviderRegistry.contract.Call(opts, &out, "getProvidersByProductType", productType, onlyActive, offset, limit)
...
//
// Solidity: function getProvidersByProductType(uint8 productType, bool onlyActive, uint256 offset, uint256 limit) view returns(((uint256,(address,address,string,string,bool),(uint8,string[],bool),bytes[])[],bool) result)
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) GetProvidersByProductType(productType uint8, onlyActive bool, offset *big.Int, limit *big.Int) (ServiceProviderRegistryStoragePaginatedProviders, error) {
	return _ServiceProviderRegistry.Contract.GetProvidersByProductType(&_ServiceProviderRegistry.CallOpts, productType, onlyActive, offset, limit)
}

// GetProvidersByProductType is a free data retrieval call binding the contract method 0x6ba44226.
//
// Solidity: function getProvidersByProductType(uint8 productType, bool onlyActive, uint256 offset, uint256 limit) view returns(((uint256,(address,address,string,string,bool),(uint8,string[],bool),bytes[])[],bool) result)
func (_ServiceProviderRegistry *ServiceProviderRegistryCallerSession) GetProvidersByProductType(productType uint8, onlyActive bool, offset *big.Int, limit *big.Int) (ServiceProviderRegistryStoragePaginatedProviders, error) {
	return _ServiceProviderRegistry.Contract.GetProvidersByProductType(&_ServiceProviderRegistry.CallOpts, productType, onlyActive, offset, limit)
}
...
func (_ServiceProviderRegistry *ServiceProviderRegistryCaller) NextUpgrade(opts *bind.CallOpts) (struct {
	NextImplementation common.Address
	AfterEpoch         *big.Int
}, error) {
	var out []interface{}
	err := _ServiceProviderRegistry.contract.Call(opts, &out, "nextUpgrade")
...
//
// Solidity: function nextUpgrade() view returns(address nextImplementation, uint96 afterEpoch)
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) NextUpgrade() (struct {
	NextImplementation common.Address
	AfterEpoch         *big.Int
}, error) {
	return _ServiceProviderRegistry.Contract.NextUpgrade(&_ServiceProviderRegistry.CallOpts)
}

// NextUpgrade is a free data retrieval call binding the contract method 0x315e49ea.
//
// Solidity: function nextUpgrade() view returns(address nextImplementation, uint96 afterEpoch)
func (_ServiceProviderRegistry *ServiceProviderRegistryCallerSession) NextUpgrade() (struct {
	NextImplementation common.Address
	AfterEpoch         *big.Int
}, error) {
	return _ServiceProviderRegistry.Contract.NextUpgrade(&_ServiceProviderRegistry.CallOpts)
...
func (_ServiceProviderRegistry *ServiceProviderRegistryCaller) ProductCapabilities(opts *bind.CallOpts, providerId *big.Int, productType uint8, key string) ([]byte, error) {
	var out []interface{}
...
//
// Solidity: function productCapabilities(uint256 providerId, uint8 productType, string key) view returns(bytes value)
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) ProductCapabilities(providerId *big.Int, productType uint8, key string) ([]byte, error) {
...
//
// Solidity: function productCapabilities(uint256 providerId, uint8 productType, string key) view returns(bytes value)
func (_ServiceProviderRegistry *ServiceProviderRegistryCallerSession) ProductCapabilities(providerId *big.Int, productType uint8, key string) ([]byte, error) {
	return _ServiceProviderRegistry.Contract.ProductCapabilities(&_ServiceProviderRegistry.CallOpts, providerId, productType, key)
}
...
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactor) AddProduct(opts *bind.TransactOpts, productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.contract.Transact(opts, "addProduct", productType, capabilityKeys, capabilityValues)
}

// AddProduct is a paid mutator transaction binding the contract method 0x360cc6ac.
//
// Solidity: function addProduct(uint8 productType, string[] capabilityKeys, bytes[] capabilityValues) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) AddProduct(productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.AddProduct(&_ServiceProviderRegistry.TransactOpts, productType, capabilityKeys, capabilityValues)
}

// AddProduct is a paid mutator transaction binding the contract method 0x360cc6ac.
//
// Solidity: function addProduct(uint8 productType, string[] capabilityKeys, bytes[] capabilityValues) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactorSession) AddProduct(productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.AddProduct(&_ServiceProviderRegistry.TransactOpts, productType, capabilityKeys, capabilityValues)
}
...
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactor) AnnouncePlannedUpgrade(opts *bind.TransactOpts, plannedUpgrade ServiceProviderRegistryPlannedUpgrade) (*types.Transaction, error) {
	return _ServiceProviderRegistry.contract.Transact(opts, "announcePlannedUpgrade", plannedUpgrade)
}

// AnnouncePlannedUpgrade is a paid mutator transaction binding the contract method 0xbd003827.
//
// Solidity: function announcePlannedUpgrade((address,uint96) plannedUpgrade) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) AnnouncePlannedUpgrade(plannedUpgrade ServiceProviderRegistryPlannedUpgrade) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.AnnouncePlannedUpgrade(&_ServiceProviderRegistry.TransactOpts, plannedUpgrade)
}

// AnnouncePlannedUpgrade is a paid mutator transaction binding the contract method 0xbd003827.
//
// Solidity: function announcePlannedUpgrade((address,uint96) plannedUpgrade) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactorSession) AnnouncePlannedUpgrade(plannedUpgrade ServiceProviderRegistryPlannedUpgrade) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.AnnouncePlannedUpgrade(&_ServiceProviderRegistry.TransactOpts, plannedUpgrade)
}
...
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactor) RegisterProvider(opts *bind.TransactOpts, payee common.Address, name string, description string, productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.contract.Transact(opts, "registerProvider", payee, name, description, productType, capabilityKeys, capabilityValues)
}

// RegisterProvider is a paid mutator transaction binding the contract method 0x90d270c2.
//
// Solidity: function registerProvider(address payee, string name, string description, uint8 productType, string[] capabilityKeys, bytes[] capabilityValues) payable returns(uint256 providerId)
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) RegisterProvider(payee common.Address, name string, description string, productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.RegisterProvider(&_ServiceProviderRegistry.TransactOpts, payee, name, description, productType, capabilityKeys, capabilityValues)
}

// RegisterProvider is a paid mutator transaction binding the contract method 0x90d270c2.
//
// Solidity: function registerProvider(address payee, string name, string description, uint8 productType, string[] capabilityKeys, bytes[] capabilityValues) payable returns(uint256 providerId)
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactorSession) RegisterProvider(payee common.Address, name string, description string, productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.RegisterProvider(&_ServiceProviderRegistry.TransactOpts, payee, name, description, productType, capabilityKeys, capabilityValues)
}
...
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactor) UpdateProduct(opts *bind.TransactOpts, productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.contract.Transact(opts, "updateProduct", productType, capabilityKeys, capabilityValues)
}

// UpdateProduct is a paid mutator transaction binding the contract method 0xa128c005.
//
// Solidity: function updateProduct(uint8 productType, string[] capabilityKeys, bytes[] capabilityValues) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistrySession) UpdateProduct(productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.UpdateProduct(&_ServiceProviderRegistry.TransactOpts, productType, capabilityKeys, capabilityValues)
}

// UpdateProduct is a paid mutator transaction binding the contract method 0xa128c005.
//
// Solidity: function updateProduct(uint8 productType, string[] capabilityKeys, bytes[] capabilityValues) returns()
func (_ServiceProviderRegistry *ServiceProviderRegistryTransactorSession) UpdateProduct(productType uint8, capabilityKeys []string, capabilityValues [][]byte) (*types.Transaction, error) {
	return _ServiceProviderRegistry.Contract.UpdateProduct(&_ServiceProviderRegistry.TransactOpts, productType, capabilityKeys, capabilityValues)
}
...
// ServiceProviderRegistryUpgradeAnnouncedIterator is returned from FilterUpgradeAnnounced and is used to iterate over the raw logs and unpacked data for UpgradeAnnounced events raised by the ServiceProviderRegistry contract.
type ServiceProviderRegistryUpgradeAnnouncedIterator struct {
	Event *ServiceProviderRegistryUpgradeAnnounced // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ServiceProviderRegistryUpgradeAnnouncedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ServiceProviderRegistryUpgradeAnnounced)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ServiceProviderRegistryUpgradeAnnouncedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ServiceProviderRegistryUpgradeAnnouncedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ServiceProviderRegistryUpgradeAnnounced represents a UpgradeAnnounced event raised by the ServiceProviderRegistry contract.
type ServiceProviderRegistryUpgradeAnnounced struct {
...
func (_ServiceProviderRegistry *ServiceProviderRegistryFilterer) FilterUpgradeAnnounced(opts *bind.FilterOpts) (*ServiceProviderRegistryUpgradeAnnouncedIterator, error) {

	logs, sub, err := _ServiceProviderRegistry.contract.FilterLogs(opts, "UpgradeAnnounced")
	if err != nil {
		return nil, err
	}
	return &ServiceProviderRegistryUpgradeAnnouncedIterator{contract: _ServiceProviderRegistry.contract, event: "UpgradeAnnounced", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event UpgradeAnnounced((address,uint96) plannedUpgrade)
func (_ServiceProviderRegistry *ServiceProviderRegistryFilterer) WatchUpgradeAnnounced(opts *bind.WatchOpts, sink chan<- *ServiceProviderRegistryUpgradeAnnounced) (event.Subscription, error) {

	logs, sub, err := _ServiceProviderRegistry.contract.WatchLogs(opts, "UpgradeAnnounced")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ServiceProviderRegistryUpgradeAnnounced)
				if err := _ServiceProviderRegistry.contract.UnpackLog(event, "UpgradeAnnounced", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event UpgradeAnnounced((address,uint96) plannedUpgrade)
func (_ServiceProviderRegistry *ServiceProviderRegistryFilterer) ParseUpgradeAnnounced(log types.Log) (*ServiceProviderRegistryUpgradeAnnounced, error) {
	event := new(ServiceProviderRegistryUpgradeAnnounced)
	if err := _ServiceProviderRegistry.contract.UnpackLog(event, "UpgradeAnnounced", log); err != nil {
		return nil, err
	}
