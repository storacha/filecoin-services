...
func (_Payments *PaymentsCaller) GetRail(opts *bind.CallOpts, railId *big.Int) (FilecoinPayV1RailView, error) {
	var out []interface{}
...
//
// Solidity: function getRail(uint256 railId) view returns((address,address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,address))
func (_Payments *PaymentsSession) GetRail(railId *big.Int) (FilecoinPayV1RailView, error) {
...
//
// Solidity: function getRail(uint256 railId) view returns((address,address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,address))
func (_Payments *PaymentsCallerSession) GetRail(railId *big.Int) (FilecoinPayV1RailView, error) {
	return _Payments.Contract.GetRail(&_Payments.CallOpts, railId)
}
