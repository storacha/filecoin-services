...
var ErrorDecoders = map[string]DecoderFunc{
	...
	"0xdb94c961": decodeClientDataSetAlreadyRegistered, // ClientDataSetAlreadyRegistered(uint256)
	...
	"0xf92ee8a9": decodeInvalidInitialization, // InvalidInitialization()
	"0x2e78e91f": decodeInvalidRateChangeQueueState, // InvalidRateChangeQueueState(uint256,uint256)
	"0x028af3d4": decodeInvalidServiceDescriptionLength, // InvalidServiceDescriptionLength(uint256)
	"0x57e65eb8": decodeInvalidServiceNameLength, // InvalidServiceNameLength(uint256)
	...
	"0xd7e6bcf8": decodeNotInitializing, // NotInitializing()
	...
	"0xe07c8dba": decodeUUPSUnauthorizedCallContext, // UUPSUnauthorizedCallContext()
	"0xaa1d49a4": decodeUUPSUnsupportedProxiableUUID, // UUPSUnsupportedProxiableUUID(bytes32)
...
// decodeAddressAlreadySet decodes AddressAlreadySet error parameters
func decodeAddressAlreadySet(data []byte) (ContractError, error) {
...
// decodeAddressEmptyCode decodes AddressEmptyCode error parameters
func decodeAddressEmptyCode(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
...
// decodeClientDataSetAlreadyRegistered decodes ClientDataSetAlreadyRegistered error parameters
func decodeClientDataSetAlreadyRegistered(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
		{Type: mustNewType("uint256")},
	}
	...
	return &ClientDataSetAlreadyRegistered{
		ClientDataSetId: values[0].(*big.Int),
	}, nil
}
...
// decodeERC1967InvalidImplementation decodes ERC1967InvalidImplementation error parameters
func decodeERC1967InvalidImplementation(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
		{Type: mustNewType("address")},
	}
	...
	return &ERC1967InvalidImplementation{
		Implementation: values[0].(common.Address),
	}, nil
}


// decodeERC1967NonPayable decodes ERC1967NonPayable error parameters
func decodeERC1967NonPayable(data []byte) (ContractError, error) {
...
// decodeIndexedError decodes IndexedError error parameters
func decodeIndexedError(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
		{Type: mustNewType("uint256")},
		{Type: mustNewType("string")},
...
// decodeInvalidInitialization decodes InvalidInitialization error parameters
func decodeInvalidInitialization(data []byte) (ContractError, error) {
...
// decodeInvalidServiceDescriptionLength decodes InvalidServiceDescriptionLength error parameters
func decodeInvalidServiceDescriptionLength(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
		{Type: mustNewType("uint256")},
	}
	...
	return &InvalidServiceDescriptionLength{
		Length: values[0].(*big.Int),
	}, nil
}


// decodeInvalidServiceNameLength decodes InvalidServiceNameLength error parameters
func decodeInvalidServiceNameLength(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
		{Type: mustNewType("uint256")},
	}
...
// decodeNotInitializing decodes NotInitializing error parameters
func decodeNotInitializing(data []byte) (ContractError, error) {
...
// decodeOwnableInvalidOwner decodes OwnableInvalidOwner error parameters
func decodeOwnableInvalidOwner(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
		{Type: mustNewType("address")},
	}
...
// decodeOwnableUnauthorizedAccount decodes OwnableUnauthorizedAccount error parameters
func decodeOwnableUnauthorizedAccount(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
		{Type: mustNewType("address")},
	}
...
// decodeUUPSUnauthorizedCallContext decodes UUPSUnauthorizedCallContext error parameters
func decodeUUPSUnauthorizedCallContext(data []byte) (ContractError, error) {
	return &UUPSUnauthorizedCallContext{}, nil
}


// decodeUUPSUnsupportedProxiableUUID decodes UUPSUnsupportedProxiableUUID error parameters
func decodeUUPSUnsupportedProxiableUUID(data []byte) (ContractError, error) {
	// Define ABI arguments
	arguments := abi.Arguments{
