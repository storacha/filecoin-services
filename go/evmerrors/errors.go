...
// AddressAlreadySet represents the AddressAlreadySet error
type AddressAlreadySet struct {
	Field uint8
}

func (e *AddressAlreadySet) Error() string {
	return fmt.Sprintf("AddressAlreadySet(Field=%v)", e.Field)
}

func (e *AddressAlreadySet) ErrorName() string {
	return "AddressAlreadySet"
}

func (e *AddressAlreadySet) ErrorSelector() string {
	return "0xca062e88"
}


// AddressEmptyCode represents the AddressEmptyCode error
type AddressEmptyCode struct {
	Target common.Address
}

func (e *AddressEmptyCode) Error() string {
	return fmt.Sprintf("AddressEmptyCode(Target=%s)", e.Target.Hex())
}

func (e *AddressEmptyCode) ErrorName() string {
	return "AddressEmptyCode"
}

func (e *AddressEmptyCode) ErrorSelector() string {
	return "0x9996b315"
}
...
// ClientDataSetAlreadyRegistered represents the ClientDataSetAlreadyRegistered error
type ClientDataSetAlreadyRegistered struct {
	ClientDataSetId *big.Int
}

func (e *ClientDataSetAlreadyRegistered) Error() string {
	return fmt.Sprintf("ClientDataSetAlreadyRegistered(ClientDataSetId=%v)", e.ClientDataSetId)
}

func (e *ClientDataSetAlreadyRegistered) ErrorName() string {
	return "ClientDataSetAlreadyRegistered"
}

func (e *ClientDataSetAlreadyRegistered) ErrorSelector() string {
	return "0xdb94c961"
}
...
// ERC1967InvalidImplementation represents the ERC1967InvalidImplementation error
type ERC1967InvalidImplementation struct {
	Implementation common.Address
}

func (e *ERC1967InvalidImplementation) Error() string {
	return fmt.Sprintf("ERC1967InvalidImplementation(Implementation=%s)", e.Implementation.Hex())
}

func (e *ERC1967InvalidImplementation) ErrorName() string {
	return "ERC1967InvalidImplementation"
}

func (e *ERC1967InvalidImplementation) ErrorSelector() string {
	return "0x4c9c8ce3"
}


// ERC1967NonPayable represents the ERC1967NonPayable error
type ERC1967NonPayable struct {
}

func (e *ERC1967NonPayable) Error() string {
	return "ERC1967NonPayable()"
}

func (e *ERC1967NonPayable) ErrorName() string {
	return "ERC1967NonPayable"
}

func (e *ERC1967NonPayable) ErrorSelector() string {
	return "0xb398979f"
}
...
func (e *FailedCall) ErrorName() string {
	return "FailedCall"
}

func (e *FailedCall) ErrorSelector() string {
	return "0xd6bda275"
}
...
// IndexedError represents the IndexedError error
...
func (e *IndexedError) Error() string {
	return fmt.Sprintf("IndexedError(Idx=%v, Msg=%s)", e.Idx, e.Msg)
}

func (e *IndexedError) ErrorName() string {
	return "IndexedError"
}

func (e *IndexedError) ErrorSelector() string {
	return "0xc7b67cf3"
}
...
// InvalidInitialization represents the InvalidInitialization error
...
func (e *InvalidInitialization) ErrorName() string {
	return "InvalidInitialization"
}

func (e *InvalidInitialization) ErrorSelector() string {
	return "0xf92ee8a9"
}
...
// InvalidServiceDescriptionLength represents the InvalidServiceDescriptionLength error
type InvalidServiceDescriptionLength struct {
	Length *big.Int
}

func (e *InvalidServiceDescriptionLength) Error() string {
	return fmt.Sprintf("InvalidServiceDescriptionLength(Length=%v)", e.Length)
}

func (e *InvalidServiceDescriptionLength) ErrorName() string {
	return "InvalidServiceDescriptionLength"
}

func (e *InvalidServiceDescriptionLength) ErrorSelector() string {
	return "0x028af3d4"
}


// InvalidServiceNameLength represents the InvalidServiceNameLength error
type InvalidServiceNameLength struct {
	Length *big.Int
}

func (e *InvalidServiceNameLength) Error() string {
	return fmt.Sprintf("InvalidServiceNameLength(Length=%v)", e.Length)
}

func (e *InvalidServiceNameLength) ErrorName() string {
	return "InvalidServiceNameLength"
}

func (e *InvalidServiceNameLength) ErrorSelector() string {
	return "0x57e65eb8"
}
...
// NotInitializing represents the NotInitializing error
type NotInitializing struct {
}

func (e *NotInitializing) Error() string {
	return "NotInitializing()"
}

func (e *NotInitializing) ErrorName() string {
	return "NotInitializing"
}

func (e *NotInitializing) ErrorSelector() string {
	return "0xd7e6bcf8"
}
...
// OwnableInvalidOwner represents the OwnableInvalidOwner error
type OwnableInvalidOwner struct {
	Owner common.Address
}

func (e *OwnableInvalidOwner) Error() string {
	return fmt.Sprintf("OwnableInvalidOwner(Owner=%s)", e.Owner.Hex())
}

func (e *OwnableInvalidOwner) ErrorName() string {
	return "OwnableInvalidOwner"
}

func (e *OwnableInvalidOwner) ErrorSelector() string {
	return "0x1e4fbdf7"
}


// OwnableUnauthorizedAccount represents the OwnableUnauthorizedAccount error
type OwnableUnauthorizedAccount struct {
	Account common.Address
}

func (e *OwnableUnauthorizedAccount) Error() string {
	return fmt.Sprintf("OwnableUnauthorizedAccount(Account=%s)", e.Account.Hex())
}

func (e *OwnableUnauthorizedAccount) ErrorName() string {
	return "OwnableUnauthorizedAccount"
}

func (e *OwnableUnauthorizedAccount) ErrorSelector() string {
	return "0x118cdaa7"
}
...
// UUPSUnauthorizedCallContext represents the UUPSUnauthorizedCallContext error
type UUPSUnauthorizedCallContext struct {
}

func (e *UUPSUnauthorizedCallContext) Error() string {
	return "UUPSUnauthorizedCallContext()"
}

func (e *UUPSUnauthorizedCallContext) ErrorName() string {
	return "UUPSUnauthorizedCallContext"
}

func (e *UUPSUnauthorizedCallContext) ErrorSelector() string {
	return "0xe07c8dba"
}


// UUPSUnsupportedProxiableUUID represents the UUPSUnsupportedProxiableUUID error
type UUPSUnsupportedProxiableUUID struct {
	Slot []byte
}

func (e *UUPSUnsupportedProxiableUUID) Error() string {
	return fmt.Sprintf("UUPSUnsupportedProxiableUUID(Slot=%v)", e.Slot)
}

func (e *UUPSUnsupportedProxiableUUID) ErrorName() string {
	return "UUPSUnsupportedProxiableUUID"
}

func (e *UUPSUnsupportedProxiableUUID) ErrorSelector() string {
	return "0xaa1d49a4"
}
