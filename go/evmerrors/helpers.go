...
// IsAddressAlreadySet checks if the error is a AddressAlreadySet error
func IsAddressAlreadySet(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*AddressAlreadySet)
	return ok
}


// IsAddressEmptyCode checks if the error is a AddressEmptyCode error
func IsAddressEmptyCode(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*AddressEmptyCode)
	return ok
}
...
// IsClientDataSetAlreadyRegistered checks if the error is a ClientDataSetAlreadyRegistered error
func IsClientDataSetAlreadyRegistered(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*ClientDataSetAlreadyRegistered)
	return ok
}
...
// IsERC1967InvalidImplementation checks if the error is a ERC1967InvalidImplementation error
func IsERC1967InvalidImplementation(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*ERC1967InvalidImplementation)
	return ok
}


// IsERC1967NonPayable checks if the error is a ERC1967NonPayable error
func IsERC1967NonPayable(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*ERC1967NonPayable)
	return ok
}
...
// IsIndexedError checks if the error is a IndexedError error
func IsIndexedError(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*IndexedError)
	return ok
}
...
// IsInvalidInitialization checks if the error is a InvalidInitialization error
func IsInvalidInitialization(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*InvalidInitialization)
	return ok
}
...
// IsInvalidServiceDescriptionLength checks if the error is a InvalidServiceDescriptionLength error
func IsInvalidServiceDescriptionLength(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*InvalidServiceDescriptionLength)
	return ok
}


// IsInvalidServiceNameLength checks if the error is a InvalidServiceNameLength error
func IsInvalidServiceNameLength(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*InvalidServiceNameLength)
	return ok
}
...
// IsNotInitializing checks if the error is a NotInitializing error
func IsNotInitializing(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*NotInitializing)
	return ok
}
...
// IsOwnableInvalidOwner checks if the error is a OwnableInvalidOwner error
func IsOwnableInvalidOwner(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*OwnableInvalidOwner)
	return ok
}


// IsOwnableUnauthorizedAccount checks if the error is a OwnableUnauthorizedAccount error
func IsOwnableUnauthorizedAccount(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*OwnableUnauthorizedAccount)
	return ok
}
...
// IsUUPSUnauthorizedCallContext checks if the error is a UUPSUnauthorizedCallContext error
func IsUUPSUnauthorizedCallContext(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*UUPSUnauthorizedCallContext)
	return ok
}


// IsUUPSUnsupportedProxiableUUID checks if the error is a UUPSUnsupportedProxiableUUID error
func IsUUPSUnsupportedProxiableUUID(err error) bool {
	if err == nil {
		return false
	}
	_, ok := err.(*UUPSUnsupportedProxiableUUID)
	return ok
}
