    ...
    EIP712Upgradeable
{
    ...
    struct ServicePricing {
        uint256 pricePerTiBPerMonthNoCDN; // Price without CDN add-on (0.9 USDFC per TiB per month)
    ...
    // Pricing constants
    uint256 private immutable STORAGE_PRICE_PER_TIB_PER_MONTH; // 0.9 USDFC per TiB per month without CDN with correct decimals
    ...
    constructor(
        ...
        // FORK: price change
        STORAGE_PRICE_PER_TIB_PER_MONTH = (9 * 10 ** TOKEN_DECIMALS) / 10; // 0.9 USDFC
