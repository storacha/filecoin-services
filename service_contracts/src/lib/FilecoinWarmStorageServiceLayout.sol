...
bytes32 constant PROVING_DEADLINES_SLOT = bytes32(uint256(3));
bytes32 constant PROVEN_THIS_PERIOD_SLOT = bytes32(uint256(4));
bytes32 constant DATA_SET_INFO_SLOT = bytes32(uint256(5));
bytes32 constant CLIENT_DATA_SETS_SLOT = bytes32(uint256(6));
bytes32 constant RAIL_TO_DATA_SET_SLOT = bytes32(uint256(7));
bytes32 constant PROVEN_PERIODS_SLOT = bytes32(uint256(8));
